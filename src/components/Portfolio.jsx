    ...
    <div>
      ...
      <div className="row">
        <div className="col-md-4">
          <div className="card">
            <img src="../../src/assets/weather-dashboard.png" className="card-img-top" alt="Weather Dashboard" />
        ...
        <div className="col-md-4">
          <div className="card">
            <img src="../../src/assets/code-quiz.png" className="card-img-top" alt="Code Quiz" />
            <div className="card-body">
        ...
        <div className="col-md-4">
          <div className="card">
            <img src="../../src/assets/happy-hour.png" className="card-img-top" alt="Happy Hour" />
            <div className="card-body">
        ...
        <div className="col-md-4">
          <div className="card">
            <img src="../../src/assets/svg-logo-maker.png" className="card-img-top" alt="SVG Logo Maker" />
            <div className="card-body">
        ...
        <div className="col-md-4">
          <div className="card">
            <img src="../../src/assets/password-generator.png" className="card-img-top" alt="Code Quiz" />
            <div className="card-body">
        ...
        <div className="col-md-4">
          <div className="card">
            <img src="../../src/assets/note-taker.png" className="card-img-top" alt="Note Taker" />
            <div className="card-body">
